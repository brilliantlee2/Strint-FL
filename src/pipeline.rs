...
pub fn run_pipeline(config: &PipelineConfig) -> Result<PipelineSummary> {
    ...
    println!("[StrintRust] Step 1/7: streaming FASTQ and extracting putative 3p/5p barcode tables");
    ...
    println!("[StrintRust] Step 2/7: reading whitelists and counting high-quality barcodes");
    let step_t0 = Instant::now();
    ...
    println!("[StrintRust] Step 3/7: correcting reads with unique-barcode caches");
    let step_t0 = Instant::now();
    ...
    println!("[StrintRust] Step 4/7: filtering corrected reads and stripping fixed barcode sequence");
    let step_t0 = Instant::now();
    ...
    println!("[StrintRust] Step 5/7: writing clean read and pair tables");
    let step_t0 = Instant::now();
    ...
    println!("[StrintRust] Step 6/7: assigning reads to graph components");
    let step_t0 = Instant::now();
    ...
    println!("[StrintRust] Step 7/7: optional FASTQ outputs");
    let step_t0 = Instant::now();
